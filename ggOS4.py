...
if c == 'help':
    ...
    if boyecs == 'f':
        print("вы открыли секретного бойца Сергей харестеристики: хранитель сервера сделал огромный вклад в сервер среди других имено он создал и придумал gg os и все идеи были его на сервере (почти) xp:5000 - 6000 lvL: 250 power: 120")
